...
<html lang="en">	
	...
	<body>
		...
		<nav class="navbar navbar-default navbar-fixed-top" style="height:50px;border:none;">
			<div class="container-fluid" style="background-color:#99E5FF;">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			    	<!-- EDIT HERE -->
			      	<!-- <p class="navbar-text navbar-right" style="color:white;margin-right:10px;">Hi, <a href="#" class="navbar-link" style="color:white;">(username)</a> | <a href="{{-- URL::route('logout') --}}" class="navbar-link" id="btn_logout" style="color:white;">logout</a></p> -->
			    </div><!-- /.navbar-collapse -->
			  </div><!-- /.container-fluid -->
		</nav>
